...
define(['lib/news_special/bootstrap'], function (news) {
    ...
    */
    var NSShareModel = function (config, namespace) {
        ...
        if (opts.image) {this.setOGPImage(opts.image); } else {this.setOGPImage('http://newsimg.bbc.co.uk/news/special/2015/newsspec_11329/content/english/img/bizquiz_opening_screen_624.jpg'); }
