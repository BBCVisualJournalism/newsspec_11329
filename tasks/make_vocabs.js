    ...
    if (worksheets !== undefined) {
        grunt.config(['cloudfile_to_vocab', 'default'], {
            options: {
                ...
                whitelisted_services:  ['english', 'arabic', 'azeri', 'bengali', 'brasil', 'burmese', 'chinese_simp', 'chinese_trad', 'cymru', 'afrique', 'gahuza', 'hausa', 'hindi', 'indonesia', 'kyrgyz', 'mundo', 'nepali', 'pashto', 'persian', 'portuguese', 'russian', 'sinhala', 'somali', 'swahili', 'tamil', 'turkish', 'ukrainian', 'urdu' , 'uzbek', 'vietnamese']
            }
        });
    }
